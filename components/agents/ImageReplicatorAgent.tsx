    ...
    return (
        <div className="animate-fade-in">
            <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-white ml-4">Analisador de Imagem (Vision)</h2>
            </div>
            <div className="flex gap-8 mt-4" style={{ height: 'calc(100vh - 12rem)' }}>
                ...
                <div className="flex-grow grid lg:grid-cols-2 gap-8 overflow-y-auto pr-4">
                        ...
                        >
                            {!preview ? (
                                <div className="cursor-pointer p-12">
                                    ...
                                    <p className="mt-4 font-semibold text-zinc-300">Arraste a imagem aqui</p>
                    ...
                    <div className="space-y-2">
                        <label className="block text-sm font-medium text-zinc-300">Prompt Gerado</label>
