...
export const AgentIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
  </svg>
);

export const ContentIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const UploadIcon: React.FC<IconProps> = ({ className = "w-10 h-10" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const SystemThemeIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
...
export const DiscordIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M20.317 4.36981C18.7915 3.69315 17.1826 3.21499 15.5223 2.94119C15.4243 3.10145 15.3129 3.32704 15.2015 3.5392C13.5612 3.22181 11.9774 3.22181 10.3936 3.5392C10.2787 3.32352 10.1673 3.10145 10.0658 2.94119C8.40546 3.21499 6.79657 3.69315 5.27115 4.36981C1.51731 8.23235 0.623122 12.1158 1.07721 16.052C3.1517 17.6893 5.34185 18.5772 7.62203 18.916C8.03812 18.3963 8.41163 17.8447 8.72166 17.2542C7.88631 16.9804 7.09355 16.6362 6.36128 16.225C6.54145 16.1415 6.71809 16.0481 6.88785 15.9511C10.2201 17.6531 14.3613 17.6531 17.6971 15.9511C17.8668 16.0481 18.0435 16.1415 18.2236 16.225C17.4913 16.6362 16.6986 16.9804 15.8632 17.2542C16.1733 17.8447 16.5468 18.3963 16.9629 18.916C19.243 18.5772 21.4332 17.6893 23.5077 16.052C24.0322 11.5833 22.9221 7.76757 20.317 4.36981ZM8.02038 13.4303C7.2023 13.4303 6.52422 12.7176 6.52422 11.8596C6.52422 10.998 7.2023 10.2853 8.02038 10.2853C8.83846 10.2853 9.51654 10.998 9.51654 11.8596C9.51654 12.7176 8.83846 13.4303 8.02038 13.4303ZM16.5684 13.4303C15.7503 13.4303 15.0722 12.7176 15.0722 11.8596C15.0722 10.998 15.7503 10.2853 16.5684 10.2853C17.3865 10.2853 18.0646 10.998 18.0646 11.8596C18.0646 12.7176 17.3865 13.4303 16.5684 13.4303Z"></path>
    </svg>
);
...
export const HeartIconSolid: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
);

export const ChatBubbleIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
...
export const ReplicateIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v2m4 4h5a2 2 0 002-2V7a2 2 0 00-2-2h-4a2 2 0 00-2 2v10a2 2 0 002 2h4a2 2 0 002-2v-2" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 3h4M9 21h4" />
  </svg>
);
